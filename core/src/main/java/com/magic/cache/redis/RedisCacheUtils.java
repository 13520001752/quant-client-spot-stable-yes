...
public class RedisCacheUtils {
    ...
    /**
     * 缓存基本的对象，Integer、String、实体类等(存在则更新)
     *
     * @param key 缓存的键值
     * @param value 缓存的值
     */
    ...
    public Long fifoPush (final String key, final Object object) {
        return redisTemplate.opsForList().leftPush(key, object);
    }

    public Long fifoPush (final String key, final Object... objects) {
        return redisTemplate.opsForList().leftPush(key, objects);
    }

    public Object fifoPop (final String key) {
